...
LINUX_IMX_SRC ?= "git://github.com/embedian/smarc-fsl-linux-kernel.git;protocol=https;branch=${SRCBRANCH}"
SRCBRANCH = "emb_lf-6.6.y"
KBRANCH = "${SRCBRANCH}"
LOCALVERSION = "-1.0.0+yocto"
SRCREV = "9c831107a0121787cfb5c03a6c1530853e920e9a"
