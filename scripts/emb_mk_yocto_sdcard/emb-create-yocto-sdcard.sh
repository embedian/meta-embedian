...
readonly BSP_TYPE="YOCTO"
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" || "${MACHINE}" = "smarcimx8mp4gdesktop" || "${MACHINE}" = "smarcimx8mp6gdesktop" || "${MACHINE}" = "pitximx8mp2gdesktop" || "${MACHINE}" = "pitximx8mp4gdesktop" || "${MACHINE}" = "pitximx8mp6gdesktop" || "${MACHINE}" = "smarcimx8mq2gdesktop" || "${MACHINE}" = "smarcimx8mq4gdesktop" || "${MACHINE}" = "smarcimx8mm2gdesktop" || "${MACHINE}" = "smarcimx8mm4gdesktop" || "${MACHINE}" = "smarcimx8qm4gdesktop" || "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
readonly YOCTO_BUILD=${YOCTO_ROOT}/build-desktop
	fi
readonly YOCTO_DEFAULT_IMAGE=imx-image-desktop

readonly YOCTO_SCRIPTS_PATH=${SCRIPT_POINT}
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mp2g
	elif [[ "${MACHINE}" = "smarcimx8mp4gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mp4g
	elif [[ "${MACHINE}" = "smarcimx8mp6gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mp6g
	elif [[ "${MACHINE}" = "pitximx8mp2gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/pitximx8mp2g
	elif [[ "${MACHINE}" = "pitximx8mp4gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/pitximx8mp4g
	elif [[ "${MACHINE}" = "pitximx8mp6gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/pitximx8mp6g
	elif [[ "${MACHINE}" = "smarcimx8mq2gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mq2g
	elif [[ "${MACHINE}" = "smarcimx8mq4gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mq4g
	elif [[ "${MACHINE}" = "smarcimx8mm2gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mm2g
	elif [[ "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8mm4g
	elif [[ "${MACHINE}" = "smarcimx8qm4gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8qm4g
	elif [[ "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
readonly YOCTO_IMGS_PATH=${YOCTO_BUILD}/tmp/deploy/images/smarcimx8qm8g
	fi
...
# Sizes are in MiB
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" || "${MACHINE}" = "smarcimx8mp4gdesktop" || "${MACHINE}" = "smarcimx8mp6gdesktop" || "${MACHINE}" = "pitximx8mp2gdesktop" || "${MACHINE}" = "pitximx8mp4gdesktop" || "${MACHINE}" = "pitximx8mp6gdesktop" || "${MACHINE}" = "smarcimx8qm4gdesktop" || "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
BOOTLOADER_OFFSET=32
	fi
	if [[ "${MACHINE}" = "smarcimx8mq2gdesktop" || "${MACHINE}" = "smarcimx8mq4gdesktop" || "${MACHINE}" = "smarcimx8mm2gdesktop" || "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
...
help() {
	bn=`basename $0`
	echo " Usage: MACHINE=<smarcimx8qm4gdesktop|smarcimx8mp2gdesktop|smarcimx8mp4gdesktop|smarcimx8mp6gdesktop|pitximx8mp2gdesktop|pitximx8mp4gdesktop|pitximx8mp6gdesktop|smarcimx8mq2gdesktop|smarcimx8mq4gdesktop|smarcimx8mm2gdesktop|smarcimx8mm4gdesktop> $bn <options> device_node"
	echo
	echo " options:"
...
if [["${MACHINE}" != "smarcimx8qm4gdesktop" && "${MACHINE}" != "smarcimx8qm8gdesktop" && "${MACHINE}" != "smarcimx8mp2gdesktop" && "${MACHINE}" != "smarcimx8mp4gdesktop" && "${MACHINE}" != "smarcimx8mp6gdesktop" && "${MACHINE}" != "pitximx8mp2gdesktop" && "${MACHINE}" != "pitximx8mp4gdesktop" && "${MACHINE}" != "pitximx8mp6gdesktop" && "${MACHINE}" != "smarcimx8mq2gdesktop" && "${MACHINE}" != "smarcimx8mq4gdesktop" && "${MACHINE}" != "smarcimx8mm2gdesktop" && "${MACHINE}" != "smarcimx8mm4gdesktop" ]] ; then
...
function install_bootloader
{
	...
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp2g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mp4gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp4g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mp6gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp6g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "pitximx8mp2gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp2g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "pitximx8mp4gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp4g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "pitximx8mp6gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp6g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mq2gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mq2g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mq4gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mq4g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mm2gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mm2g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mm4g-sd.bin-flash_evk of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8qm4gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8qm4g-sd.bin-flash_linux_m4 of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	elif [[ "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
	dd if=${YOCTO_IMGS_PATH}/imx-boot-smarcimx8qm8g-sd.bin-flash_linux_m4 of=${LPARAM_BLOCK_DEVICE} bs=1K seek=${BOOTLOADER_OFFSET}; sync
	fi
}
...
function install_yocto
{
	...
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" || "${MACHINE}" = "smarcimx8mp4gdesktop" || "${MACHINE}" = "smarcimx8mp6gdesktop" ]]; then
	...
	elif [[ "${MACHINE}" = "smarcimx8qm4gdesktop" || "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
	...
	elif [[ "${MACHINE}" = "pitximx8mp2gdesktop" || "${MACHINE}" = "pitximx8mp4gdesktop" || "${MACHINE}" = "pitximx8mp6gdesktop" ]]; then
	...
	elif [[ "${MACHINE}" = "smarcimx8mq2gdesktop" || "${MACHINE}" = "smarcimx8mq4gdesktop" ]]; then
	...
	elif [[ "${MACHINE}" = "smarcimx8mm2gdesktop" || "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
	...
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mp2g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mp4gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mp4g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mp6gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mp6g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "pitximx8mp2gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-pitximx8mp2g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "pitximx8mp4gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-pitximx8mp4g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "pitximx8mp6gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-pitximx8mp6g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mq2gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mq2g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mq4gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mq4g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mm2gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mm2g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8mm4g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8qm4gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8qm4g.tar.bz2 -C ${P2_MOUNT_DIR}/
	elif [[ "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
	tar jxvf ${YOCTO_IMGS_PATH}/${YOCTO_DEFAULT_IMAGE}-smarcimx8qm8g.tar.bz2 -C ${P2_MOUNT_DIR}/
        fi
	sync
}
...
function copy_images
{
	...
	if [[ "${MACHINE}" = "smarcimx8mp2gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp2g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mp2g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mp4gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp4g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mp4g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mp6gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mp6g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mp6g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "pitximx8mp2gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp2g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-pitximx8mp2g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "pitximx8mp4gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp4g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-pitximx8mp4g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "pitximx8mp6gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-pitximx8mp6g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-pitximx8mp6g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mq2gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mq2g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mq2g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mq4gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mq4g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mq4g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mm2gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mm2g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mm2g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8mm4gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8mm4g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8mm4g-sd.bin-flash_evk imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8qm4gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8qm4g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8qm4g-sd.bin-flash_linux_m4 imx-boot-sd.bin)
	elif [[ "${MACHINE}" = "smarcimx8qm8gdesktop" ]]; then
		cp ${YOCTO_IMGS_PATH}/imx-boot-smarcimx8qm8g-sd.bin-* ${P2_MOUNT_DIR}/opt/images/Yocto
		(cd ${P2_MOUNT_DIR}/opt/images/Yocto; ln -fs imx-boot-smarcimx8qm8g-sd.bin-flash_linux_m4 imx-boot-sd.bin)
	else
