...
compile_mx93:prepend:smarcimx932g() {
	echo "Copying DTB"
	if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx93-smarc.dtb ]; then
	  cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx93-11x11-evk.dtb
	fi
}

compile_mx93:prepend:smarcimx931g() {
        echo "Copying DTB"
        if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx93-smarc.dtb ]; then
          cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx93-11x11-evk.dtb
	fi
...
compile_mx8:prepend:smarcimx8qm4g() {
        ...
        if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx8qm-smarc.dtb ]; then
          cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx8qm-mek.dtb
        fi
}
...
compile_mx8m:prepend:smarcimx8mp2g() {
        ...
        if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx8mp-smarc.dtb ]; then
          cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx8mp-evk.dtb
        fi
}
...
compile_mx8m:prepend:smarcimx8mq2g() {
        ...
        if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx8mq-smarc.dtb ]; then
          cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx8mq-evk.dtb
        fi
}
...
compile_mx8m:prepend:smarcimx8mm2g() {
        ...
        if [ -f ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/imx8mm-smarc.dtb ]; then
          cp ${DEPLOY_DIR_IMAGE}/${BOOT_TOOLS}/${UBOOT_DTB_NAME_EXTRA} ${BOOT_STAGING}/imx8mm-evk.dtb
        fi
}
